...
| *libbitcoin_ipc*         | IPC functionality used by *zenium-node*, *zenium-wallet*, *bitcoin-gui* executables to communicate when [`--enable-multiprocess`](multiprocess.md) is used. |
