...
The following command, for example, creates a descriptor wallet. More information about this command may be found by running `zenium-cli help createwallet`.

```
$ zenium-cli createwallet "wallet-01"
```
...
```
$ zenium-cli -rpcwallet="wallet-01" encryptwallet "passphrase"
```

Once encrypted, the passphrase can be changed with the `walletpassphrasechange` command.

```
$ zenium-cli -rpcwallet="wallet-01" walletpassphrasechange "oldpassphrase" "newpassphrase"
```
...
```
$ zenium-cli -named createwallet wallet_name="wallet-01" passphrase="passphrase"
```
...
```
$ zenium-cli -rpcwallet="wallet-01" backupwallet /home/node01/Backups/backup-01.dat
```
...
```
$ zenium-cli restorewallet "restored-wallet" /home/node01/Backups/backup-01.dat
```

After that, `getwalletinfo` can be used to check if the wallet has been fully restored.

```
$ zenium-cli -rpcwallet="restored-wallet" getwalletinfo
```
