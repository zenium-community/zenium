...
As of Zenium Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/zenium-community/guix.sigs/). When
...
builder-keys](https://github.com/zenium-community/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://bitcoincore.org and https://zenium.org.
