...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of zenium node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple zenium ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple zenium ports', file=sys.stderr)
