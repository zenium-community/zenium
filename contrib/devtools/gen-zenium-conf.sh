...
BITCOIND=${BITCOIND:-$BINDIR/zeniumd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/zenium.conf}
...
then
  ...
  echo -e "To safely generate a zenium.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example zenium.conf file in share/examples/'
...
##
## zenium.conf configuration file.
## Generated by contrib/devtools/gen-zenium-conf.sh.
##
...
# parse the output from zeniumd --help
