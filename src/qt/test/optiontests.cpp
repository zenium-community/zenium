...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Bitcoin/Zenium-Qt.conf and all else left as default,
    // zenium-qt should set both -listen and -listenonion to false and start successfully.
