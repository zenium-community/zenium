...
{
    switch (unit) {
    case Unit::BTC: return QString("Zeniums");
    case Unit::mBTC: return QString("Milli-Zeniums (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Zeniums (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
