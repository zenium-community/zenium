...
{
    BOOST_CHECK(TestSplitHost("www.zenium.org", "www.zenium.org", 0));
    BOOST_CHECK(TestSplitHost("[www.zenium.org]", "www.zenium.org", 0));
    BOOST_CHECK(TestSplitHost("www.zenium.org:80", "www.zenium.org", 80));
    BOOST_CHECK(TestSplitHost("[www.zenium.org]:80", "www.zenium.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.zenium.org:65536", "www.zenium.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.zenium.org:0", "www.zenium.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.zenium.org:", "www.zenium.org:", 0, false));
}
