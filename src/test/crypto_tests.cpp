...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Zenium relies on 80 byte header hashes, we want to have an example for that.",
               "02643327e409994c2a023fd53b5caf18b962adbae680a74949a818f903f40f37");
