// Copyright (c) 2009-2022 The Zenium Core developers
 ...
 *  Zenium because since the activation of BIP66, signatures are verified to be
...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
     ...
     * not historically been enforced in Zenium, so normalize them first. */
