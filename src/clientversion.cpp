 ...
 * for both zeniumd and zenium-qt, to make it harder for attackers to
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Zenium Core copyright is not removed by accident
    if (copyright_devs.find("Zenium Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Zenium Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/zenium-community/zenium>";
