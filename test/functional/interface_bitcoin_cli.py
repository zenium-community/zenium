...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `zenium-cli getblockchaininfo`")
        ...
        # Prevent zenium-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and zenium-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and zenium-cli getwalletinfo return expected wallet info")
            ...
            # Test zenium-cli -generate with -rpcwallet in multiwallet mode.
