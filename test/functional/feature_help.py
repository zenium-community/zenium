...
"""Verify that starting zenium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zenium with -h for help text")
        ...
        self.log.info("Start zenium with -version for version information")
        ...
        self.log.info("Start zeniumd with -fakearg to make sure it does not start")
