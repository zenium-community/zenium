...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The zeniumd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # zeniumd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that zeniumd sends its own version prior to processing
