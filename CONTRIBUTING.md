Contributing to Zenium Core
============================

The Zenium Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Zenium Core
...
Before you start contributing, familiarize yourself with the Zenium Core build
system and tests. Refer to the documentation in the repository on how to build
Zenium Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Zenium Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Zenium Core development happens on IRC, in the
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to zenium-qt
...
fork of Zenium Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Zenium Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Zenium
Network Protocol consensus changes.

Whether a pull request is merged into Zenium Core rests with the project merge
maintainers.
...
Patches that change Zenium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zenium consensus, it must have been
